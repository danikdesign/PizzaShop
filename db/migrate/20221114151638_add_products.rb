class AddProducts < ActiveRecord::Migration[7.0]
  def change
    ...
    Product.create :title => 'Hawaiian', :description => 'Pizza sauce, cheese, cooked ham, and pineapple', :price => 350, :size => 30, :is_spicy => false, :is_veg => false, :is_best_offer => false, :path_to_image => '/images/hawaii.png'
    ...
    Product.create :title => 'Vegetarian', :description => 'Crispy pizza crust, tomato sauce & bubbly cheese.', :price => 400, :size => 30, :is_spicy => false, :is_veg => true, :is_best_offer => false, :path_to_image => '/images/vegetarian.png'
